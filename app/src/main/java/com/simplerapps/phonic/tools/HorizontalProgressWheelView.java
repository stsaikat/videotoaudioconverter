...
public class HorizontalProgressWheelView extends View {
    ...
    private void init() {
        mMiddleLineColor = Color.BLACK; //ContextCompat.getColor(getContext(), R.color.ucrop_color_widget_rotate_mid_line);

        mProgressLineWidth = 4; //getContext().getResources().getDimensionPixelSize(R.dimen.ucrop_width_horizontal_wheel_progress_line);
        mProgressLineHeight = 20; //getContext().getResources().getDimensionPixelSize(R.dimen.ucrop_height_horizontal_wheel_progress_line);
        mProgressLineMargin = 12; //getContext().getResources().getDimensionPixelSize(R.dimen.ucrop_margin_horizontal_wheel_progress_line);
        ...
        mProgressLinePaint.setColor(Color.BLACK /*getResources().getColor(R.color.ucrop_color_progress_wheel_line)*/);

        mProgressMiddleLinePaint = new Paint(mProgressLinePaint);
        mProgressMiddleLinePaint.setColor(mMiddleLineColor);
        mProgressMiddleLinePaint.setStrokeCap(Paint.Cap.ROUND);
        mProgressMiddleLinePaint.setStrokeWidth(8/*getContext().getResources().getDimensionPixelSize(R.dimen.ucrop_width_middle_wheel_progress_line)*/);
    }
